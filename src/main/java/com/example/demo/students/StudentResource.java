...
public class StudentResource {
	...
	//pour afficher les détails de tous les étudiants
	@GetMapping("/students")
	public List<Student> retrieveAllStudents() {
		return studentRepository.findAll();
	}
	
	//pour récuperer les détails d'un étudiant spécifique
...
Les beans renvoyés sont convertis vers / à partir de JSON / XML.
@Autowired private StudentRepository studentRepository : 
Autowire le StudentRepository afin que nous puissions récupérer
 et sauvegarder des données dans une base de données.
*/